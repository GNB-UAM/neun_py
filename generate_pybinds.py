...
class PyBindsGenerator:
    ...
    def _generate_headers(self) -> str:
        ...
        headers.append('#include "DifferentialNeuronWrapper.h"')
    ...
    def _generate_neuron_registration(self) -> str:
        ...
        lines.append('    using ModelType = Model<Precision>;')
        lines.append('    using WrappedModelType = SystemWrapper<ModelType>;')
        lines.append('    using NeuronType = DifferentialNeuronWrapper<WrappedModelType, Integrator>;')
        lines.append('    ')
    ...
    def _generate_synaptic_pairs(self) -> str:
        ...
        lines.append('        using DummyNeuron = DifferentialNeuronWrapper<SystemWrapper<HodgkinHuxleyModel<Precision>>, RungeKutta4>;')
        ...
        lines.append('    using WrappedModel1Type = SystemWrapper<Model1Type>;')
        lines.append('    using WrappedModel2Type = SystemWrapper<Model2Type>;')
        lines.append('    using Neuron1Type = DifferentialNeuronWrapper<WrappedModel1Type, Integrator>;')
        lines.append('    using Neuron2Type = DifferentialNeuronWrapper<WrappedModel2Type, Integrator>;')
